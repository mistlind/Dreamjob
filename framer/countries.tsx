 ...
 *
 * This file contains a comprehensive list of countries with their:
 * - ISO 3166-1 alpha-2 country code
 * - Country name
 * - Emoji flag (using regional indicator symbols)
 *
 * The emoji flags are created by converting the 2-letter country code
 * to regional indicator symbol letters (Unicode).
 */
...
// Helper to get display string with flag
...
// Export sorted alphabetically by name
